...
# ** GET *****
@app.route("/tb_registro_ext", methods=["GET"])
...
@app.route("/tb_registro_ext/<id>", methods=["GET"])
...
@app.route("/tb_registro_ext/<id>", methods=["DELETE"])
