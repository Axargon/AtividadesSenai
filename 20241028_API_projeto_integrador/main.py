...
def seleciona_registro():
    ...
    registros_json = [Registro.to_json()for registro in registro_objeto]
...
def seleciona_registro_id(id):
    ...
    if registro_objeto:
        registros_json = registro_objeto.to_json()
        return gera_resposta(200, "registro", registros_json)
    else:
...
def criar_dados ():
    try:
        ...
        return jsonify({"mensagem": "Dados criados com sucesso"}), 201
    except Exception as e:
